...
public class BloodExplosionEffect
extends FinalKillCosmetic {
    ...
    public void runEffect(Location location) {
        AnimationUtil.playBlockBreak(location, Material.REDSTONE_BLOCK);
        AnimationUtil.playBlockBreak(location.clone().add(0.0, 1.0, 0.0), Material.REDSTONE_BLOCK);
    }
}
