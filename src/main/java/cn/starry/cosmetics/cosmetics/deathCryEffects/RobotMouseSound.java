...
public class RobotMouseSound
    ...
    public List<String> getDescription() {
        return Arrays.asList("&7当你死亡时", "&7播放机械鼠的亡语");
    }
    ...
    public void runSound(Location location) {
        Misc.play(location, 5.0, "mob.guardian.land.death", 1.0f, 0.0f);
    }

    @Override
    public void runPreview(Player player) {
        player.playSound(player.getLocation(), "mob.guardian.land.death", 1.0f, 0.0f);
    }
}
