...
public class PumpkinPieProjectile
extends ProjectileTrailCosmetic {
    ...
    public void runParticleEffect(Location loc) {
        Item i = loc.getWorld().dropItem(loc, new ItemBuilder(Material.PUMPKIN_PIE).setDisplayName(String.valueOf(System.currentTimeMillis())).build());
